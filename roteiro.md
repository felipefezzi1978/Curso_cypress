...
O usuário acessa a página de cadastro;
O usuário deixa algum dos campos obrigatórios (como o nome, e-mail ou a confirmação da senha) em branco;
O usuário clica no botão de "Cadastrar".

Resultados Esperados:
O sistema valida os campos em branco.
O sistema exibe mensagens de erro indicando que os campos obrigatórios devem ser preenchidos.

Regra de Negócio:
Os campos E-mail e Senha são campos obrigatórios para o cadastro.
...
Cenário 3: Login sistema com sucesso

Passos:

O usuário acessa a página de login.
O usuário insere seu e-mail "ana@email.com" e senha "Senha123" nos campos correspondentes.
O usuário clica no botão "Entrar".

Resultados Esperados:
O sistema autentica as credenciais fornecidas.
O sistema redireciona o usuãrio para a pãgina "/home".
